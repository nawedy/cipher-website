// src/app/divisions/digitalworks/page.tsx
// Complete Cipher DigitalWorks landing page focused on growth and content automation

'use client';

import React, { useState } from 'react';
import { motion } from 'framer-motion';
import { ArrowRight, BarChart3, Zap, Play, Calendar, MessageSquare } from 'lucide-react';
...
import { digitalworksDivisionConfig } from '@/data/divisions/digitalworks';
import { getDivisionTheme } from '@/lib/divisions';

export default function DigitalWorksPage() {
  const [activeDemo, setActiveDemo] = useState<'dashboard' | 'content'>('dashboard');
  const theme = getDivisionTheme('digitalworks');
  const config = digitalworksDivisionConfig;

  const handleGetStarted = () => {
    window.location.href = '/contact?division=digitalworks&utm_source=landing_hero';
  };

  const handleWatchDemo = () => {
    setActiveDemo(activeDemo === 'dashboard' ? 'content' : 'dashboard');
  };

  const handleServiceClick = (serviceId: string) => {
    window.location.href = `/contact?division=digitalworks&service=${serviceId}&utm_source=services_grid`;
  };

  const handlePlanSelect = (planId: string) => {
    window.location.href = `/contact?division=digitalworks&plan=${planId}&utm_source=pricing_section`;
  };

  return (
    <DivisionLayout divisionId="digitalworks">
      {/* Hero Section */}
      <section id="hero">
        <DivisionHero
          division={config}
          ...
          <BlurFade delay={0.2}>
            <div className="text-center mb-12">
              <p className="text-lg font-medium" style={{ color: theme.textSecondary }}>
                Accelerating growth for innovative brands worldwide
              </p>
            </div>
          </BlurFade>
          <Marquee className="py-4" pauseOnHover>
            <div className="flex w-64 flex-col justify-between rounded-lg border bg-card p-4 text-card-foreground shadow-sm mx-4">
              <p className="text-sm leading-relaxed text-muted-foreground">
                "Cipher DigitalWorks revolutionized our content strategy. Their AI-powered tools helped us create 10x more content in half the time."
              </p>
              <div className="mt-4">
                <p className="font-semibold">Sarah Chen</p>
                <p className="text-xs text-muted-foreground">Marketing Director, TechFlow</p>
              </div>
            </div>
            <div className="flex w-64 flex-col justify-between rounded-lg border bg-card p-4 text-card-foreground shadow-sm mx-4">
              <p className="text-sm leading-relaxed text-muted-foreground">
                "The automation workflows saved us 40 hours per week. ROI was immediate and substantial."
              </p>
              <div className="mt-4">
                <p className="font-semibold">Michael Rodriguez</p>
                <p className="text-xs text-muted-foreground">Operations Manager, ScaleUp Inc</p>
              </div>
            </div>
          </Marquee>
        </div>
          ...
          <BlurFade delay={0.2}>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6" style={{ color: theme.textPrimary }}>
                See Growth Automation in Action
              </h2>
              <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: theme.textSecondary }}>
                Experience how our AI-powered systems transform content creation and campaign performance at scale.
              </p>
            </div>
          </BlurFade>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="flex justify-center mb-8">
                <div className="flex p-1 backdrop-blur-sm rounded-lg" style={{ backgroundColor: `${theme.cardBackground}80`, border: `1px solid ${theme.border}` }}>
                  ...
                  <Button
                    variant={activeDemo === 'content' ? 'default' : 'ghost'}
                    onClick={() => setActiveDemo('content')}
                    className="px-6 py-2"
                    style={activeDemo === 'content' ? { backgroundColor: theme.neon, color: theme.background } : { color: theme.textSecondary }}
                  >
                  ...
                  {activeDemo === 'dashboard' ? (
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        {[
                          { label: 'Content Output', value: 15, suffix: 'x', color: theme.neon },
                          { label: 'Engagement Rate', value: 340, suffix: '%', color: theme.accent },
                          { label: 'Lead Quality', value: 280, suffix: '%', color: theme.secondary },
                          { label: 'Cost Reduction', value: 67, suffix: '%', color: theme.primary }
                        ].map((metric, index) => (
                          <motion.div
                            key={metric.label}
                      ...
                      <div className="text-center">
                        <p className="text-lg" style={{ color: theme.textSecondary }}>
                          Real-time growth metrics powered by intelligent automation
                        </p>
                      </div>
                    </div>
                  ) : (
                    <div className="space-y-6">
                      <div className="text-center mb-6">
                        ...
                        <p className="text-sm" style={{ color: theme.textSecondary }}>
                          Watch our AI create engaging content in real-time
                        </p>
                      </div>
                      <div className="bg-gray-900 rounded-lg p-6 font-mono text-sm">
                        <div className="flex items-center mb-4">
                          ...
                          <span className="ml-4 text-gray-400">Content Generator v2.0</span>
                        </div>
                        <div className="space-y-2">
                          <div style={{ color: theme.neon }}>
                            <TypingAnimation
                              ...
                              className="text-sm"
                            >
                              {`🚀 BLOG POST: '5 AI Trends Transforming Business in 2024' - COMPLETE ✅
📱 SOCIAL POSTS: LinkedIn, Twitter, Instagram variants - GENERATED ✅  
📧 EMAIL CAMPAIGN: Welcome series (5 emails) - OPTIMIZED ✅
🎯 AD COPY: Google & Facebook ads (10 variants) - READY ✅`}
                            </TypingAnimation>
                          </div>
                        </div>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <BlurFade delay={0.2}>
            <div className="text-center mb-16">
              ...
              <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: theme.textSecondary }}>
                A systematic approach to scaling your digital presence and accelerating sustainable growth.
              </p>
            </div>
          </BlurFade>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <BlurFade delay={0.2}>
            <div className="text-center mb-16">
              ...
              <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: theme.textSecondary }}>
                See how we transformed a struggling e-commerce brand into a growth powerhouse.
              </p>
            </div>
          </BlurFade>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <BlurFade delay={0.2}>
            <div className="text-center mb-16">
              ...
              <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: theme.textSecondary }}>
                Trusted by growth-focused companies who demand results and value innovation.
              </p>
            </div>
          </BlurFade>
          ...
          <BlurFade delay={0.2}>
            <div className="text-center mb-16">
              ...
              <p className="text-xl leading-relaxed" style={{ color: theme.textSecondary }}>
                Get answers to common questions about our growth automation services.
              </p>
            </div>
          </BlurFade>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <BlurFade delay={0.2}>
            ...
            <p className="text-xl leading-relaxed mb-8" style={{ color: theme.textSecondary }}>
              Join innovative companies who trust DigitalWorks to scale their content, campaigns, and growth systems.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                ...
                onClick={() => window.location.href = '/contact?division=digitalworks&action=consultation&utm_source=final_cta'}
              >
